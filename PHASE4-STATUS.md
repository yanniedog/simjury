...
> **⏸ PARKED (2026-07-13) + ANDROID FROZEN (2026-07-27):** the owner pivoted the repo to
> the daily synthetic track — see [`DAILY-PIVOT.md`](DAILY-PIVOT.md). Case c_001 **stays
> live** at simjury.com/play; the remaining G-4 items below (R3 human clearance, R4 device
> QA, R5 gate PR) and the Android pilot are **frozen until further notice**. Do not edit
> `pilot/` app code or re-enable Android CI/release workflows without an owner instruction.
> This file is the frozen handoff for whenever the historical/Android track resumes.
