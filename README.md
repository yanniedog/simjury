...
requests only an opaque content hash, never case text or player data. Missing clips fall
back to an English voice advertised as local by the browser; Cloudflare never synthesizes
or stores narration.
