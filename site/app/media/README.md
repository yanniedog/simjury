...
Chirp 3 HD stock-voice casting metadata is generated by
`npm run media:performance:manifest`; it grants no alternative-provider,
reference-audio or runtime inference authority and follows
[`docs/COURT-WEEK-OFFLINE-VOICE-BAKEOFF.md`](../../../docs/COURT-WEEK-OFFLINE-VOICE-BAKEOFF.md).
