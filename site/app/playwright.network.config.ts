...
export default defineConfig({
  ...
  use: {
    ...
    baseURL: 'http://127.0.0.1:49317/jury/court-week.html',
  ...
  webServer: {
    command: 'npm run preview -- --outDir ../public --host 127.0.0.1 --port 49317 --strictPort',
    url: 'http://127.0.0.1:49317/jury/court-week.html',
