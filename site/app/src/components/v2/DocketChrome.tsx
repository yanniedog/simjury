    ...
    <main className="docket-shell min-h-screen text-neutral-100">
      ...
      <div className="docket-workspace">
        ...
        <aside className="juror-docket" aria-label="Juror docket">
          ...
          {sidebar}
          <p className="local-note"><span aria-hidden="true">◆</span> Your progress and narration stay on this device. Your verdict and case text are never sent to a backend.</p>
        </aside>
      </div>
    </main>
  )
