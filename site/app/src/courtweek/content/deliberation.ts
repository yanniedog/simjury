...
export const elevenMinutesDeliberation: DeliberationPack = {
  jurors: [
    ...
    { id: 'juror-02', name: 'Niko Hale', occupation: 'Ferry mechanic', concern: 'Whether the medical evidence excludes a reasonable same-outcome possibility', reasoningStrength: 'Tests expert assumptions against physical evidence', vulnerability: 'Can demand scientific certainty beyond the criminal standard' },
    ...
    { id: 'juror-09', name: 'Yara Merrow', occupation: 'Information-security analyst', concern: 'Why an intentional wrongdoer would create permanent account records', reasoningStrength: 'Tests the Crown theory for operational coherence', vulnerability: 'Can assume wrongdoing always follows a sophisticated concealment plan' },
  ...
  propositions: [
    {
      id: 'prop-intent-sequence-support',
      sceneIds: ['sat-room', 'sat-concerns', 'sat-first-ballot', 'sat-separate', 'sun-persevere'],
      legalQuestion: 'Did Venn intend death or really serious injury, making the offence murder?',
      evidenceIds: ['ex-audit-log', 'ex-distress'], moves: ['connect', 'test-source'],
      lawfulRationale: 'The authenticated sequence and distress words may support the distinct inference of murderous intent.',
      influence: { issue: 'murder', direction: 1 },
    },
    {
      id: 'prop-intent-error-alternative',
      sceneIds: ['sat-room', 'sat-concerns', 'sat-first-ballot', 'sat-separate', 'sun-persevere'],
      legalQuestion: 'Did Venn intend death or really serious injury, making the offence murder?',
      evidenceIds: ['ex-ready-display', 'ex-warning'], moves: ['distinguish', 'raise-alternative'],
      lawfulRationale: 'A reasonable safety-error explanation defeats murderous intent but leaves the separate manslaughter questions live.',
      influence: { issue: 'murder', direction: -1, counterVerdict: 'manslaughter' },
    },
    {
      id: 'prop-negligence-delay-support',
      sceneIds: ['sat-room', 'sat-concerns', 'sat-first-ballot', 'sat-separate', 'sun-negligence', 'sun-persevere'],
      legalQuestion: 'If murder is not proved, was the deliberate duty breach so gross and the risk so high that it was manslaughter by criminal negligence?',
      evidenceIds: ['ex-warning', 'ex-audit-log'], moves: ['connect', 'distinguish'],
      lawfulRationale: 'The deliberate delay under an unchanged warning may support gross criminal negligence without proving murderous intent.',
      influence: { issue: 'manslaughter', direction: 1 },
    },
    {
      id: 'prop-negligence-safety-alternative',
      sceneIds: ['sat-room', 'sat-concerns', 'sat-first-ballot', 'sat-separate', 'sun-negligence', 'sun-persevere'],
      legalQuestion: 'If murder is not proved, was the deliberate duty breach so gross and the risk so high that it was manslaughter by criminal negligence?',
      evidenceIds: ['ex-ready-display', 'ex-competing'], moves: ['raise-alternative', 'apply-burden'],
      lawfulRationale: 'The warning and competing emergencies may preserve reasonable doubt about the demanding criminal-negligence threshold.',
      influence: { issue: 'manslaughter', direction: -1, counterVerdict: 'not-guilty' },
    },
    {
      id: 'prop-causation-window-support',
      sceneIds: ['sat-room', 'sat-first-ballot', 'sat-causation', 'sat-separate', 'sun-negligence', 'sun-persevere'],
      legalQuestion: 'Did that omission substantially and operatively cause Ilan Saye’s death beyond reasonable doubt?',
      evidenceIds: ['ex-survival', 'ex-distress'], moves: ['connect', 'test-source'],
      lawfulRationale: 'The survival opinion and conscious transmission may prove common causation, but they do not prove murderous intent.',
      influence: { issue: 'manslaughter', direction: 1 },
    },
    {
      id: 'prop-causation-window-doubt',
      sceneIds: ['sat-room', 'sat-first-ballot', 'sat-causation', 'sat-separate', 'sun-negligence', 'sun-persevere'],
      legalQuestion: 'Did that omission substantially and operatively cause Ilan Saye’s death beyond reasonable doubt?',
      evidenceIds: ['ex-survival', 'ex-route'], moves: ['challenge-inference', 'apply-burden'],
      lawfulRationale: 'Reasonable doubt about causation defeats both charged offences and therefore may support acquittal.',
      influence: { issue: 'not-guilty', direction: 1 },
    },
    {
      id: 'prop-intent-source-limit', sceneIds: ['sat-concerns', 'sun-resume'],
      legalQuestion: 'Did Venn intend death or really serious injury, making the offence murder?',
      evidenceIds: ['ex-audit-log', 'ex-review'], moves: ['challenge-inference', 'apply-burden'],
      lawfulRationale: 'Source limits weaken an intent inference but do not decide whether the separate manslaughter offence is proved.',
      influence: { issue: 'not-guilty', direction: 0 },
    },
    {
      id: 'prop-resume-intent-alternative', sceneIds: ['sun-resume'],
      legalQuestion: 'Did Venn intend death or really serious injury, making the offence murder?',
      evidenceIds: ['ex-ready-display', 'ex-warning'], moves: ['distinguish', 'challenge-inference'],
      lawfulRationale: 'The judge’s answer may move a juror from murder to manslaughter, but does not itself establish acquittal.',
      influence: { issue: 'murder', direction: -1, counterVerdict: 'manslaughter' },
    },
    {
      id: 'prop-resume-negligence-support', sceneIds: ['sun-resume'],
      legalQuestion: 'If murder is not proved, was the deliberate duty breach so gross and the risk so high that it was manslaughter by criminal negligence?',
      evidenceIds: ['ex-warning', 'ex-audit-log'], moves: ['distinguish', 'apply-burden'],
      lawfulRationale: 'After murder fails, the unchanged warning and deliberate delay may independently support manslaughter.',
      influence: { issue: 'manslaughter', direction: 1 },
    },
    {
      id: 'prop-improper-boundary', sceneIds: ['sat-improper'],
      legalQuestion: 'Did Venn intend death or really serious injury, making the offence murder?',
      evidenceIds: ['ex-audit-log', 'ex-review'], moves: ['test-source', 'apply-burden'],
      lawfulRationale: 'Correcting an improper argument restores lawful process and supplies no evidence for any verdict.',
      influence: { issue: 'not-guilty', direction: 0 },
    },
    {
      id: 'prop-causation-route-support', sceneIds: ['sat-causation'],
      legalQuestion: 'Did that omission substantially and operatively cause Ilan Saye’s death beyond reasonable doubt?',
      evidenceIds: ['ex-route', 'ex-competing'], moves: ['connect', 'test-source'],
      lawfulRationale: 'Route and workload records test travel assumptions but cannot prove medical causation or murderous intent.',
      influence: { issue: 'murder', direction: 0 },
    },
    {
      id: 'prop-duty-source-limit', sceneIds: ['sun-persevere'],
      legalQuestion: 'Did Mara Venn intentionally fail to perform the accepted-alert duty without reasonably prioritising a greater imminent peril?',
      evidenceIds: ['ex-route', 'ex-warning'], moves: ['test-source', 'apply-burden'],
      lawfulRationale: 'Testing the route and warning sources alone does not resolve duty breach, causation or either offence.',
      influence: { issue: 'not-guilty', direction: 0 },
    },
    {
      id: 'prop-duty-priority-doubt', sceneIds: ['sat-concerns'],
      legalQuestion: 'Did Mara Venn intentionally fail to perform the accepted-alert duty without reasonably prioritising a greater imminent peril?',
      evidenceIds: ['ex-competing', 'ex-warning'], moves: ['distinguish', 'apply-burden'],
      lawfulRationale: 'Reasonable doubt that the controller breached the accepted-alert duty defeats the common duty basis of both offences.',
      influence: { issue: 'not-guilty', direction: 1 },
    },
  ],
  improperArguments: [
  ...
  firstBallot: { murder: 5, manslaughter: 2, 'not-guilty': 3, 'unable-to-agree': 1 },
