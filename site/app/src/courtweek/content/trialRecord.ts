...
export const elevenMinutesTrialRecord: TrialRecord = {
  ...
  witnesses: [
    ...
    { id: 'w-vale', name: 'Oren Vale', calledBy: 'Crown', role: 'Compliance director', chiefCueIds: ['wed-vale-chief-1'], crossCueIds: ['wed-vale-cross-1', 'wed-blurt'], reexaminationCueIds: [], reexaminationScope: [] },
