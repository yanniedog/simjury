...
export const elevenMinutesTrialRecord: TrialRecord = {
  ...
  witnesses: [
    ...
    { id: 'w-mir', name: 'Tovan Mir', calledBy: 'Crown', role: 'Records custodian', chiefCueIds: ['tue-mir-chief-1', 'tue-mir-chief-2', 'tue-mir-chief-3'], crossCueIds: ['tue-mir-cross-1'], reexaminationCueIds: [], reexaminationScope: [] },
    { id: 'w-pell', name: 'Jaro Pell', calledBy: 'Crown', role: 'Rescue supervisor', chiefCueIds: ['wed-pell-chief-1', 'wed-ready-admitted'], crossCueIds: ['wed-pell-cross-1'], reexaminationCueIds: ['wed-pell-re-1'], reexaminationScope: ['What READY conveyed despite the separate warning'] },
    ...
    { id: 'w-vale', name: 'Oren Vale', calledBy: 'Crown', role: 'Compliance director', chiefCueIds: ['wed-vale-foundation', 'wed-vale-chief-1'], crossCueIds: ['wed-vale-cross-1', 'wed-blurt'], reexaminationCueIds: [], reexaminationScope: [] },
    ...
    { id: 'w-quill', name: 'Sera Quill', calledBy: 'Defence', role: 'Maintenance engineer', chiefCueIds: ['thu-quill-chief-1', 'thu-warning-admitted'], crossCueIds: ['thu-quill-cross-1'], reexaminationCueIds: ['thu-quill-re-1'], reexaminationScope: ['Operational warning information available if control called and whether READY displayed it'] },
  ],
  objections: [
