...
export const TUESDAY_SPEECH_CANDIDATE: readonly TuesdaySpeechCandidateCue[] = [
  ...
  cue('tue-mir-chief-2', 'exhibit-admitted', [
    ...
    turn('tue-mir-chief-2__6', 'tovan-mir', 'Tovan Mir', 'live-proceeding', 'foundation', 'Yes. In my ordinary records work, I routinely reviewed incident strips completed by Mara Venn before this event. I recognise this as her ordinary handwriting. The entry reads, “hold, readiness,” but the paper cannot tell us when she wrote it or why.', [['“hold, readiness,”', 'written', 'accused']]),
