...
export const TUESDAY_SPEECH_CANDIDATE: readonly TuesdaySpeechCandidateCue[] = [
  ...
  cue('tue-mir-chief-1', 'exhibit-admitted', [
    ...
    turn('tue-mir-chief-1__4', 'tovan-mir', 'Tovan Mir', 'live-proceeding', 'foundation', 'Each controller signs in with a hardware key and personal code. The system records every action under that account automatically in a sequential audit ledger, where later entries do not overwrite earlier ones. It also writes a distinct ingestion entry for each event. I checked the sequence and ingestion entries for gaps and found none. The court copy’s S H A two fifty-six digital fingerprint matches the retained archive file, which shows those two files are identical, byte for byte. The archive clock was within two seconds of the station clock.'),
    ...
    turn('tue-mir-chief-1__6', 'tovan-mir', 'Tovan Mir', 'live-proceeding', 'answer', 'It records actions under Mara Venn’s authenticated account: acceptance of A R seventy-one at twenty-one sixteen and eight seconds, a downgrade and confirmation, then release of Kestrel at twenty-one twenty-seven and twenty-nine seconds.'),
    ...
    turn('tue-mir-chief-1__8', 'tovan-mir', 'Tovan Mir', 'live-proceeding', 'foundation', 'The incident board records each entry automatically. I checked the hour’s first and last sequence numbers and event count against the sequential audit ledger; the sequence was continuous and the counts agreed. I then generated the court export from the retained archive file. Its digital fingerprint matches the fingerprint in the retained manifest, which identifies the North Station snapshot and A R seventy-one.'),
  ...
  cue('tue-mir-chief-2', 'exhibit-admitted', [
    turn('tue-mir-chief-2__1', 'crown-counsel', 'Crown counsel Asha Renn', 'live-proceeding', 'question', 'What records connect the yellow launch strip to this incident and its collection?'),
    turn('tue-mir-chief-2__2', 'tovan-mir', 'Tovan Mir', 'live-proceeding', 'foundation', 'The printer audit shows that it printed automatically when the incident was accepted. Its incident number and print sequence match the audit log. I did not see the collection. A signed property receipt identifies the output tray at Mara Venn’s console as the place of collection.'),
    ...
    turn('tue-mir-chief-2__6', 'tovan-mir', 'Tovan Mir', 'live-proceeding', 'foundation', 'Yes. In my ordinary records work, I routinely reviewed incident strips completed by Mara Venn before this event. I recognise this as her ordinary handwriting. The entry reads “hold—readiness”.', [['“hold—readiness”', 'written', 'accused']]),
    ...
    turn('tue-mir-chief-2__9', 'judge', 'Judge Sel Aven', 'judicial-direction', 'limitation-direction', 'The strip’s words and handwriting do not establish when the note was written or why. Those are matters for you to decide, if you can, from all the evidence.'),
  ]),
  cue('tue-mir-chief-3', 'witness-chief', [
    ...
    turn('tue-mir-chief-3__2', 'tovan-mir', 'Tovan Mir', 'live-proceeding', 'answer', 'The console recorded the distress channel automatically. When a recording closed, the system wrote its incident identifier, start and end times, duration and digital fingerprint to the sequential ingestion ledger.'),
    ...
    turn('tue-mir-chief-3__4', 'tovan-mir', 'Tovan Mir', 'live-proceeding', 'foundation', 'I exported the court copy from the retained archive file. Its S H A two fifty-six digital fingerprint matches the retained recording, showing that those two files are identical, byte for byte. I also checked its incident identifier, start and end times and duration against the automatic ingestion entry; they agree.'),
    ...
    turn('tue-mir-chief-3__6', 'tovan-mir', 'Tovan Mir', 'live-proceeding', 'foundation', 'The automatic capture entry shows that the snapshot process completed at the stated time and records its row count and incident identifier. I checked both against the sequential incident board ledger. The court copy’s digital fingerprint matches the retained snapshot. It shows the status ready exactly as retained; the main tile did not display the warning detail shown on another page.'),
  ]),
  cue('tue-mir-cross-1', 'witness-cross', [
    ...
    turn('tue-mir-cross-1__5', 'defence-counsel', 'Defence counsel Corin Dax', 'live-proceeding', 'question', 'An entry created by the hardware key identifies activity under the authenticated account; it cannot prove who touched the controls?'),
    turn('tue-mir-cross-1__6', 'tovan-mir', 'Tovan Mir', 'live-proceeding', 'answer', 'That is correct.'),
    turn('tue-mir-cross-1__7', 'defence-counsel', 'Defence counsel Corin Dax', 'live-proceeding', 'question', 'And the log cannot show panic, mistake or intent?'),
    turn('tue-mir-cross-1__8', 'tovan-mir', 'Tovan Mir', 'live-proceeding', 'answer', 'Correct.'),
  ]),
  cue('tue-log-direction', 'preliminary-direction', [
    turn('tue-log-direction__1', 'judge', 'Judge Sel Aven', 'judicial-direction', 'direction', 'The log records activity under Mara Venn’s authenticated account. Whether she was the person at the controls is for you to decide from all the evidence. She need not prove that someone else acted. The Crown bears the burden throughout. If a reasonable possibility consistent with innocence remains on the evidence about an element, that element is not proved beyond reasonable doubt.'),
  ]),
  cue('tue-recording-final-admission', 'exhibit-admitted', [
    turn('tue-recording-final-admission__1', 'judge', 'Judge Sel Aven', 'judicial-direction', 'admission', 'Mir’s evidence about automatic capture, archive continuity and the court copy satisfies the outstanding foundation condition. The distress recording’s provisional admission is now final.'),
    turn('tue-recording-final-admission__2', 'judge', 'Judge Sel Aven', 'judicial-direction', 'limitation-direction', 'The recording’s weight is for you. Use it only for what is actually audible and assess it with all the evidence. System evidence alone cannot identify who operated a console or what anyone intended.'),
  ...
  cue('tue-adjourn-1', 'adjournment', [
    turn('tue-adjourn-1__1', 'judge', 'Judge Sel Aven', 'judicial-direction', 'direction', 'Counsel’s descriptions are not evidence. Do not discuss the case or undertake any research overnight. Tomorrow you will hear from the rescue supervisor, a medical expert and the compliance director. Causation and alleged motive remain contested. Court will adjourn until tomorrow morning.'),
  ]),
  cue('tue-adjourn-2', 'adjournment', [
    turn('tue-adjourn-2__1', 'court-officer', 'Court Attendant', 'live-proceeding', 'none', 'All rise.'),
    turn('tue-adjourn-2__2', 'narrator', 'Narrator', 'narration', 'narration', 'The admitted recording and exhibits remain available in the juror desk. Save observations rather than a verdict. A useful note distinguishes the system data from what that data may mean.'),
  ]),
]
