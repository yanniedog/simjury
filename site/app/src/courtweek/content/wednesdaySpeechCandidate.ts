...
export const WEDNESDAY_SPEECH_CANDIDATE: readonly WednesdaySpeechCandidateCue[] = [
  ...
  cue('wed-pell-chief-1', 'witness-chief', [
    turn('wed-pell-chief-1__1', 'jaro-pell', 'Jaro Pell', 'reported-testimony', 'answer', 'I supervised Kestrel. READY meant the crew was aboard, engines warm and launch authorised. We saw a steering-pressure warning fluctuate, but the engineer had not grounded the craft. At 21:17 I called control: “Kestrel ready, warning monitored.” We received the order at 21:27 and cast off forty-eight seconds later.', [['“Kestrel ready, warning monitored.”', 'reported', 'jaro-pell']]),
  ]),
  cue('wed-ready-admitted', 'exhibit-admitted', [
    turn('wed-ready-admitted__1', 'jaro-pell', 'Jaro Pell', 'live-proceeding', 'foundation', 'The status snapshot accurately shows the word READY. Its short label does not show the warning detail, which appeared on a separate page. A controller could dispatch while the warning was present, ask us for clarification or hold if she reasonably judged the risk too high. No automated rule made that judgment for her.'),
    turn('wed-ready-admitted__2', 'crown-counsel', 'Crown counsel Asha Renn', 'advocacy', 'tender', 'I tender the North Station status snapshot on Mir’s integrity evidence and Pell’s explanation.'),
    turn('wed-ready-admitted__3', 'judge', 'Judge Sel Aven', 'judicial-direction', 'admission', 'The North Station status snapshot is admitted.'),
    turn('wed-ready-admitted__4', 'judge', 'Judge Sel Aven', 'judicial-direction', 'limitation-direction', 'The snapshot shows the READY label. It does not display the separate warning detail or decide whether dispatch or delay was reasonable.'),
  ], { evidenceAdmission: { evidenceId: 'ex-ready-display', status: 'final', operativeTurnId: 'wed-ready-admitted__3', limitationTurnId: 'wed-ready-admitted__4' } }),
  cue('wed-pell-cross-1', 'witness-cross', [
    turn('wed-pell-cross-1__1', 'defence-counsel', 'Defence counsel Corin Dax', 'live-proceeding', 'question', 'The warning concerned steering pressure in storm water?'),
  ...
  cue('wed-vos-chief-1', 'witness-chief', [
    turn('wed-vos-chief-1__1', 'eren-vos', 'Dr Eren Vos', 'live-proceeding', 'foundation', 'I am a marine survival physician with fourteen years’ clinical and research experience in cold-water immersion. My disclosed report uses accepted immersion datasets, the recorded water temperature, clothing, reported injury and rescue track; both sides received the source tables and assumptions.'),
    turn('wed-vos-chief-1__2', 'eren-vos', 'Dr Eren Vos', 'live-proceeding', 'answer', 'There is no clock that reveals an individual’s precise death. My opinion is that dispatch at 21:16 would probably have placed recovery inside a medically significant survival window. Dispatch at 21:27 probably placed it outside. I use probably deliberately; I cannot promise survival.'),
  ]),
  ...
  cue('wed-def-objection', 'objection', [
    ...
    turn('wed-def-objection__2', 'defence-counsel', 'Defence counsel Corin Dax', 'live-proceeding', 'objection', 'Objection—relevance.'),
    ...
    turn('wed-def-objection__5', 'judge', 'Judge Sel Aven', 'judicial-direction', 'ruling', 'Overruled. The witness may answer.'),
  ...
  cue('wed-vale-chief-1', 'exhibit-admitted', [
    turn('wed-vale-chief-1__1', 'oren-vale', 'Oren Vale', 'live-proceeding', 'foundation', 'I direct compliance reviews. This is the unfinished memorandum Saye stored in our safety-office system. I recognise its ordinary format; unchanged metadata identifies Saye as author. It proposed suspending Venn’s certification because of two earlier response delays. It was not sent to her.'),
    turn('wed-vale-chief-1__2', 'oren-vale', 'Oren Vale', 'reported-testimony', 'answer', 'Three days before the storm, I heard Venn ask whether “Ilan was trying to end my career.” I told her the review was unfinished and no decision had been made.', [['“Ilan was trying to end my career.”', 'reported', 'accused']]),
    turn('wed-vale-chief-1__3', 'crown-counsel', 'Crown counsel Asha Renn', 'advocacy', 'tender', 'I tender the unfinished memorandum.'),
    turn('wed-vale-chief-1__4', 'defence-counsel', 'Defence counsel Corin Dax', 'advocacy', 'submission', 'No further objection, subject to the ruling.'),
    turn('wed-vale-chief-1__5', 'judge', 'Judge Sel Aven', 'judicial-direction', 'admission', 'The unfinished memorandum is admitted.'),
    turn('wed-vale-chief-1__6', 'judge', 'Judge Sel Aven', 'judicial-direction', 'limitation-direction', 'Use it only for possible knowledge and motive if you find that connection. It is not a final finding and is not proof of character.'),
  ], {
    attributions: [{ marker: 'Venn ask', actorId: 'accused', kind: 'reported' }],
    evidenceAdmission: { evidenceId: 'ex-review', status: 'final', operativeTurnId: 'wed-vale-chief-1__5', limitationTurnId: 'wed-vale-chief-1__6' },
  }),
  ...
  cue('wed-postanswer-ruling', 'ruling', [
    turn('wed-postanswer-ruling__1', 'judge', 'Judge Sel Aven', 'judicial-direction', 'ruling', 'Sustained. The volunteered answer is struck.'),
    turn('wed-postanswer-ruling__2', 'judge', 'Judge Sel Aven', 'judicial-direction', 'limitation-direction', 'The struck words are untested hearsay, not evidence of any earlier act, habit or character. Reason as though they were never spoken. Do not replay or repeat them. They must not appear in exhibits, the notes index, closings, deliberation prompts or later analysis. Counsel, move to another subject.'),
  ...
  cue('wed-record-admitted', 'exhibit-admitted', [
    turn('wed-record-admitted__1', 'crown-counsel', 'Crown counsel Asha Renn', 'advocacy', 'tender', 'I tender the complete concurrent-incident export. Its archive link, hash method and verified clock rest on Mir’s foundation tested yesterday; Dorn identified the assignments.'),
  ...
  cue('wed-crown-close-1', 'crown-close', [
    turn('wed-crown-close-1__1', 'crown-counsel', 'Crown counsel Asha Renn', 'advocacy', 'submission', 'Your Honour, that is the evidence for the Crown. We close our case. No later Crown witness will repair a missing foundation. The defence will now decide what evidence, if any, to call; the burden remains with the Crown.'),
  ]),
  ...
  cue('wed-adjourn-2', 'adjournment', [
    turn('wed-adjourn-2__1', 'court-officer', 'Court officer', 'live-proceeding', 'none', 'Tomorrow the defence will open and call two witnesses. Keep your notes provisional and private. Court is adjourned.'),
  ]),
]
