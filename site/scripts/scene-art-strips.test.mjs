...
// resource-contended Windows libvips host. Keep a finite ceiling with roughly
// 45% headroom over that observed platform variance.
const ART_STRIP_SETUP_TIMEOUT_MS = 1_200_000
let manifest
